...
//    public class OptionsWindow : EditorWindow // where T : class
//    {
...
//        public void Init(OptionsWindow window, Type type, SerializedProperty property, OptionWindowType windowType)
//        {
//            this.window = window;
