namespace UtilityAI
{
    ...
    public sealed class TacticalMoveAction : ActionWithOptions<Vector3>
    {
        ...
        //    context.entity.agent.SetDestination(destination);
        //    //context.entity.agent.isStopped = false;

        //    while (hasReachedDestination == false)
        //    {
        //        if (context.entity.agent.pathPending == false && GetDistanceRemaining(context) <= context.entity.agent.stoppingDistance){
        //            //context.entity.agent.isStopped = true; //  Stop walking.
        ...
        //{
        //    float distance = 0.0f;
        //    Vector3[] corners = context.entity.agent.path.corners;
