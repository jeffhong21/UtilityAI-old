namespace UtilityAI
{
    ...
    public class AIEntityPerceptionModule : MonoBehaviour
    {
		...
		{
            entity = GetComponent<AIEntityController>();
        ...
        public void ScanForTargets(LayerMask layer, out List<Transform> data)
        {
